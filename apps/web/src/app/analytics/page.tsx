  ...
  return (
    <div className="flex flex-col gap-6 max-w-6xl mx-auto pb-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard label={t('analytics.stats.revenue')} value={moneyLong.format(periodRevenue)} tone="positive" sub={periodLabel} />
        <StatCard label={t('analytics.stats.expenses')} value={moneyLong.format(periodExpenses)} tone="negative" sub={periodLabel} />
        <StatCard label={t('analytics.stats.netProfit')} value={moneyLong.format(periodProfit)} tone={periodProfit >= 0 ? 'positive' : 'negative'} sub={periodLabel} />
